...
// Rest => operador '...', é usado como argumento de função
...
//Spread => operador '...' é usado como concatenador, console.log, etc
var numeros = [1, 2, 3, 4];
(_console = console).log.apply(_console, numeros);
var timesFutebolSp = ['Santos', 'Palmeiras', 'Bragantino', 'São Paulo'];
var timesFutebolRj = ['Vasco', 'Bota-Fogo', 'Flamento', 'Fluminense'];
var timesFutebol = [].concat(timesFutebolSp, timesFutebolRj);
...
//desestruturação e Alias
//const motorAna = carroAna.motor;
